...
DATABASES = {
    'default': dj_database_url.config(
        default=config('DATABASE_URL', default='postgres://avnadmin:AVNS_5MFIaTaV_Ypdw4KECXX@niner-path-app-mysql-database2.c.aivencloud.com:17668/defaultdb?sslmode=require'),
        ssl_require=True
    )
}
